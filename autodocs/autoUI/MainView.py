...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.FillPersonForm_button = QtWidgets.QPushButton(self.tab_a1)
        self.FillPersonForm_button.setObjectName("FillPersonForm_button")
        self.horizontalLayout_3.addWidget(self.FillPersonForm_button)
        self.SkipNextPersonForm_button = QtWidgets.QPushButton(self.tab_a1)
        self.SkipNextPersonForm_button.setObjectName("SkipNextPersonForm_button")
        self.horizontalLayout_3.addWidget(self.SkipNextPersonForm_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.FillPersonForm_button.setToolTip(_translate("MainWindow", "Pridėkite naują anketą o tada paspauskite kad jį būtų užpildyta su sekančio asmens informacija"))
        self.FillPersonForm_button.setText(_translate("MainWindow", "Užpildyti asmens anketą"))
        self.SkipNextPersonForm_button.setToolTip(_translate("MainWindow", "Pasirinkti sekantį asmenį iš sąrašo"))
        self.SkipNextPersonForm_button.setText(_translate("MainWindow", "Pasirinkti sekantį asmenį"))
